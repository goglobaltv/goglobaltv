...
export default function AlgricultureItem({ allNews }) {
  const display_Box = {
    base: "95%",
    sm: "95%",
    md: "90%",
          ...
          >
            <GridItem colSpan={1}>
              ...
              >
                {allNews
                  ?.filter(
                    (newData) => newData?.newsCategory?.name === "Agriculture"
                  )
                  .map((newData) => (
            ...
            <GridItem colSpan={1}>
              <Weather />
              {/* <Image src="Go Global School-v.gif" alt="advertisment" />
              <Image mt="10px" src="../Mart Ads -05.jpg" alt="advertisement" /> */}
